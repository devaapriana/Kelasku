...
<div class="container-md shadow p-3 mb-5 centered  p-5" style="padding: 0; margin-top:0;border-radius:15px;position:relative;">
    ...
    ?>
    <img class="rounded-circle" src="<?php echo base_url('assets/'); ?>img/<?php echo $user['gambar']; ?>" alt="" style="width: 150px;height:150px;position:absolute;top:-80px;right:44%;border:1px solid grey;">
    <br>
        ...
        <?php foreach ($menu as $m) : ?>
            ...
            <?php foreach ($subMenu as $sm) : ?>
                ...
                <div class="card shadow p-3" style="padding-top: 5px;border-radius:15px;">
                    <img src=" <?php echo base_url('assets/img/') ?><?php echo $sm['image']; ?>" class="card-img-top" alt="...">
                    <div class="card-body">
